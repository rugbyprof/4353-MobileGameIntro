var preload = {
	preload:function(){
		...
		game.load.image('starfield', 'assets/images/starfield.png');
		game.load.image('thrust', 'assets/images/flipv2.png');
		...
		game.load.atlas('google_earth','assets/sprites/earth_hight_quality.png','assets/sprites/earth_hight_quality.json');
		game.load.atlas('ufoFlip','assets/sprites/ufo_flip2.png','assets/sprites/ufo_flip2.json');
