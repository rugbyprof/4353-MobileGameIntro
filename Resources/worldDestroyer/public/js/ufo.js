function Ufo(game_copy) {
    ...
    this.create = function (x, y, x_scale, y_scale) {
        ...
        this.ship.body.setSize(this.ship.width + 12, this.ship.height + 3);
        this.ship.alpha = 1;
        this.ship.bringToTop();


        this.thrust = game.add.sprite(x, y, 'thrust');
        this.thrust.alpha = 0;
        game.physics.enable(this.thrust, Phaser.Physics.ARCADE);
        this.thrust.enableBody = true;
        this.thrust.body.collideWorldBounds = false;
        this.thrust.scale.setTo(this.xScale, this.yScale);
        this.thrust.anchor.setTo(.5, .5);
        this.thrust.body.setSize(this.ship.width + 12, this.ship.height + 3);
        ...
        this.flipUfoSprite = game.add.sprite(0, 0, 'ufoFlip');
        this.flipUfoSprite.alpha = 0;
        this.flipUfoSprite.scale.setTo(this.xScale, this.yScale);
        this.flipUfoSprite.anchor.setTo(.5, .5);
        //this.flipUfoSprite.body.setSize(this.ship.width+12 , this.ship.height+3);
        ...
        this.flipAnimation['left'] = this.flipUfoSprite.animations.add('left', Phaser.Animation.generateFrameNames('flipv2_left', 1, 34), 100, false);
        this.flipAnimation['left'].onComplete.add(this.flipStopped, this);
        this.flipAnimation['right'] = this.flipUfoSprite.animations.add('right', Phaser.Animation.generateFrameNames('flipv2_right', 1, 34), 100, false);
        this.flipAnimation['right'].onComplete.add(this.flipStopped, this);
    ...
    this.flipShip = function (direction) {
        this.flipUfoSprite.alpha = 1;
        this.flipUfoSprite.x = this.ship.x;
        this.flipUfoSprite.y = this.ship.y;
        this.flipAnimation[direction].play(direction);
        //needs callback to make disappear
    };

    this.flipStopped = function () {
        this.flipUfoSprite.alpha = 0;
    };
