var level_02 = {
	...
	create: function () {
		...
		game.knight.create(game.camera.width / 2, game.camera.height / 2, this.layers);
		...
		game.physics.enable([game.knight.sprite, this.portal], Phaser.Physics.ARCADE);
	...
	update: function () {
		...
		if(game.knight.isOverlapped(this.portal)){
			console.log("bingo");
		...
		game.physics.arcade.collide(game.knight.sprite, this.layers.collision_layer);
