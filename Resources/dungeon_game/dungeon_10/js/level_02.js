var level_02 = {
	...
	create: function () {
		...
		this.sword = game.add.sprite(game.camera.width / 2, game.camera.height / 2, 'swords');
		...
		this.player.animations.add('attack_left', Phaser.Animation.generateFrameNames('Attack_left', 0, 9), 40, false);
		this.player.animations.add('attack_right', Phaser.Animation.generateFrameNames('Attack_right', 0, 9), 40, false);
		this.player.animations.add('jump_attack_left', Phaser.Animation.generateFrameNames('JumpAttack_left', 0, 9), 40, false);
		this.player.animations.add('jump_attack_right', Phaser.Animation.generateFrameNames('JumpAttack_right', 0, 9), 40, false);
		...
		this.attack = game.input.keyboard.addKey(Phaser.Keyboard.SHIFT);
	...
	update: function () {
		...
		if (!this.player_busy) {
			...
			// if the portal "exists" (it is an object) then check to see if its overlapped 
			// with a player.
	...
	showPortal: function (x, y) {
		var portal = game.add.sprite(0, 0, 'red_portal');
		portal.animations.add('rotate', Phaser.Animation.generateFrameNames('red_portal', 1, 3), 60, true);
		portal.animations.play('rotate');
		portal.alpha = 0;
